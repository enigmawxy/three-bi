import '../lib/d3.v2.min';
import '../lib/jquery-ui-1.8.21.custom.min';
/**
ui.control.js
...
export var d3Graphs = {
    ...
    showHud: function(spec) {
        ...
        $("#hudHeader .countryTextInput").autocomplete({ source:spec.selectableCountries });
    ...
    drawBarGraph: function(spec) {
        ...
        for(var type in spec.reverseWeaponLookup) {
            importArray.push({"type":type, "amount":spec.selectedCountry.summary.imported[type]});
            exportArray.push({"type":type, "amount":spec.selectedCountry.summary.exported[type]});
        }
