...
export var THREEp	= THREEp 		|| {};

THREEp.Projector = function() {
    ...
    this.projectVector = function ( vector, camera ) {
        ...
        // _projScreenMatrix.applyMatrix4( vector );

        _projScreenMatrix.multiplyMatrices( camera.projectionMatrix, camera.matrixWorldInverse );
        // _projScreenMatrix.applyMatrix4( vector );
        vector.applyMatrix4(_projScreenMatrix);
    ...
    this.unprojectVector = function ( vector, camera ) {
        ...
        // _projScreenMatrix.multiplyMatrices( camera.matrixWorld, camera.projectionMatrixInverse );
        // _projScreenMatrix.applyMatrix4( vector );
    ...
    this.projectGraph = function ( root, sort ) {
        ...
        var projectObject = function ( object ) {
            ...
            if ( ( object instanceof THREE.Mesh || object instanceof THREE.Line ) &&
                ...
                _vector3.copy( object.position ).applyMatrix4(_projScreenMatrix);
                // _projScreenMatrix.applyMatrix4( _vector3.copy( object.position ) );
        ...
        for ( o = 0, ol = _renderData.objects.length; o < ol; o++ ) {
            ...
            if ( object instanceof THREE.Mesh ) {
                ...
                for ( v = 0, vl = vertices.length; v < vl; v ++ ) {
                    ...
                    _vertex.positionWorld.applyMatrix4(objectMatrixWorld);
                    // objectMatrixWorld.applyMatrix4( _vertex.positionWorld );

                    _vertex.positionScreen.copy( _vertex.positionWorld );
                    _vertex.positionScreen.applyMatrix4(_projScreenMatrix);
                ...
                for ( f = 0, fl = faces.length; f < fl; f ++ ) {
                    ...
                    _face.normalWorld.applyMatrix4(objectMatrixWorldRotation);
                    // objectMatrixWorldRotation.applyMatrix4( _face.normalWorld );

                    _face.centroidWorld.copy( face.centroid );
                    _face.centroidWorld.applyMatrix4(objectMatrixWorld);
                    // objectMatrixWorld.applyMatrix4( _face.centroidWorld );

                    _face.centroidScreen.copy( _face.centroidWorld );
                    _face.centroidScreen.applyMatrix4(_projScreenMatrix);
                    // _projScreenMatrix.applyMatrix4( _face.centroidScreen );
                    ...
                    for ( n = 0, nl = faceVertexNormals.length; n < nl; n ++ ) {
                        ...
                        _face.normal.applyMatrix4(objectMatrixWorldRotation);
                        // objectMatrixWorldRotation.applyMatrix4( normal );
                ...
                _projScreenobjectMatrixWorld.multiplyMatrices( _projScreenMatrix, objectMatrixWorld );
